 ...
 <div id="navbar-full">
    ...
    <div class="navigation-example">
        ...
        <!-- Collect the nav links, forms, and other content for toggling -->
            ...
            <div class="img-src" style="background-image: url('<?php plantilla_url(); ?>/images/gsd/bg.jpg')"></div>
        </div>
    </div><!--  end navbar -->
    ...
    <div class="container tim-container">
        ...
        <div id="images">
            ...
            <div class="row">
                <div class="col-md-4">
                    <h4>Rounded Image</h4>
                    <img src="<?php plantilla_url(); ?>/images/gsd/mockup.png" alt="Rounded Image" class="img-rounded">
                    
                </div>
                <div class="col-md-4">
                    <h4>Circle Image</h4>
                    <img src="<?php plantilla_url(); ?>/images/gsd/mockup.png" alt="Circle Image" class="img-circle">
                   
                </div>
                <div class="col-md-4">
                    <h4>Thumbnail Image</h4>
                    <img src="<?php plantilla_url(); ?>/images/gsd/mockup.png" alt="Thumbnail Image" class="img-thumbnail">
    ...
    <div id="carousel-example-generic" class="carousel slide gsdk-transition" data-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="item active">
          <img src="<?php plantilla_url(); ?>/images/gsd/carousel_blue.png" alt="Awesome Image">
        </div>
        <div class="item">
          <img src="<?php plantilla_url(); ?>/images/gsd/carousel_green.png" alt="Awesome Image">
        </div>
        <div class="item">
          <img src="<?php plantilla_url(); ?>/images/gsd/carousel_red.png" alt="Awesome Image">
        </div>
      </div>
